...
public abstract class PostgresDbContext : IDisposable, IAsyncDisposable
{
    private readonly Dictionary<Type, object> _sets = [];
    private readonly PostgresDbContextOptions _options;
    ...
    {
        var builder = new PostgresDbContextOptionsBuilder();
        OnConfiguring(builder);
        _options = builder.Build();
    }

    protected PostgresDbContext(Action<PostgresDbContextOptionsBuilder> configure)
    {
        var builder = new PostgresDbContextOptionsBuilder();
        configure(builder);
        OnConfiguring(builder);
    ...
    protected virtual void OnConfiguring(PostgresDbContextOptionsBuilder builder)
    {
    }
